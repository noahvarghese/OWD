...
<head>
    ...
    <meta charset="utf-8" />
    <link rel="stylesheet" href="<?= Config::$STYLE_PATH . $results["css"] . ".css" ?>" />
    <link rel="stylesheet" href="<?= Config::$STYLE_PATH . "nav.css" ?>" />
    <link rel="stylesheet" href="<?= Config::$STYLE_PATH . "admin.css" ?>" />
    <link rel="icon" type="image/x-icon" href="<?= Config::$IMG_PATH . "favicon.ico" ?>" />
    <script type="text/javascript" src="<?= Config::$JS_PATH . $action . ".js" ?>"></script>
    <script type="text/javascript" src="<?= Config::$JS_PATH . "admin.js" ?>"></script>
</head>
