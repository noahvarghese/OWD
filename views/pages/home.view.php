...
<div id="bannerLogo">
    <img alt="banner logo" src="<?= Config::$IMG_PATH . "logo.png" ?>" />
</div>
...
<div id="items">
    <div id="firstLayer" class="layer icons">
        <div>
            <img class="icon" id="localIcon" alt="local" src="<?= Config::$IMG_PATH . 'location.png' ?>" />
        </div>
        <div>
            <img class="icon" id="canadaIcon" alt="canada" src="<?= Config::$IMG_PATH . 'canada.png' ?>" />
        </div>
        <div>
            <img class="icon" id="pricingIcon" alt="pricing" src="<?= Config::$IMG_PATH . 'financing.png' ?>" />
        </div>
    </div>
    ...
    <div id="thirdLayer" class="layer icons">
        <div>
            <img class="icon" id="warrantyIcon" alt="warranty" src="<?= Config::$IMG_PATH . 'warranty.png' ?>" />
        </div>
        <div>
            <img class="icon" id="showroomIcon" alt="showroom" src="<?= Config::$IMG_PATH . 'storeFront.png' ?>" />
        </div>
        <div>
            <img class="icon" id="approvalIcon" alt="pre-approval" src="<?= Config::$IMG_PATH . 'certified.png' ?>" />
        </div>
    </div>
