...
class Mail {
    private static string $businessEmail = "sales@oakvillewindows.com";
    ...
    public static function send()
    {
        ...
        if ( $_SERVER['REQUEST_METHOD'] === "POST" )
        {
            ...
            if ( $valid )
            {
                ...
                $businessHeaders[] = "To: Oakville Windows And Doors <" . Mail::$businessEmail . ">";
                ...
                $businessMessage .= $businessContent;
                $businessMessage .= $content;
        
                mail($businessEmail, $businessSubject, $businessMessage, implode("\r\n", $businessHeaders));
                ...
                $senderMessage .= $senderContent;
                $senderMessage .= $content;
        
                mail($email, $senderSubject, $senderMessage, implode("\r\n", $senderHeaders));
