        ...
        <footer id="Footer">
            <div className="row">
                ...
                <div className="socialMedia">
                    <a
                        href="https://instagram.com/oakvillewindows.doors/"
                    ...
                    <a
                        href="https://facebook.com/oakvillewindows.doors"
                        rel="noopener noreferrer"
                        target="_blank"
                    >
                    ...
                    <a
                        href="https://linkedin.com/company/oakville-windows-&-doors"
                        rel="noopener noreferrer"
                        target="_blank"
                    >
                    ...
                    <a
                        href="mailto:info@oakvillewindows.com"
                        rel="noopener noreferrer"
                        target="_blank"
                    >
